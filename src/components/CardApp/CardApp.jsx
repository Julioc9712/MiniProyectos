      ...
      <div className="container-card">
        <div className="card">
          ...
          <div className="card-body">
            ...
            <p className="card-text">
              Miniproyecto React de clima: consumo de API con fetch y uso de
              useState y useEffect para mostrar datos meteorológicos según la
              ubicación.
            </p>
        ...
        <div className="card">
          ...
          <div className="card-body">
            ...
            <p className="card-text">
              Mini proyecto de React CRUD, creando una lista de objetivos de
              desarrollo frontend con funciones de agregar, editar y eliminar
            </p>
            <br />
